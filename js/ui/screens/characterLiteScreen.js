...
import { renderPlayerAvatar, SKIN_TONES, HAIR_STYLES, HAIR_COLORS, OUTFIT_IDS } from '../components/avatarBuilder.js?v=7';
import { APP_KEY } from '../../data/shorts/langConfig.js?v=7';
