...
import { GROWTH_STAGES, worldLevelIndex } from '../../data/worldLevels.js?v=7';
import { renderPlayerAvatar, SKIN_TONES, HAIR_COLORS, HAIR_STYLES, OUTFIT_IDS } from '../components/avatarBuilder.js?v=7';
